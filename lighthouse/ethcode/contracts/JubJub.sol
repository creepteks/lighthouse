...
library JubJub
{
    ...
    // added by crypteks to match babyjubjub and eddsa impl in circomlib
    // refer to circomlib/src/babyjubjub.js and eddsa.js
    function Base8() internal pure returns (uint256[2] memory)
    {
        return 
